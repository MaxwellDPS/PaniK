...
public class CellBroadcastAlertAudio extends Service  {
    ...
    public static final String ALERT_AUDIO_TONE_TYPE = "com.skyfall.panik.ALERT_AUDIO_TONE_TYPE";

    /** Extra for alert vibration pattern (unless main volume is silent). */
    public static final String ALERT_AUDIO_VIBRATION_PATTERN_EXTRA = "com.skyfall.panik.ALERT_AUDIO_VIBRATION_PATTERN";

    /** Extra for playing alert sound in full volume regardless Do Not Disturb is on. */
    public static final String ALERT_AUDIO_OVERRIDE_DND_EXTRA = "com.skyfall.panik.ALERT_OVERRIDE_DND_EXTRA";

    /** Extra for cutomized alert duration in ms. */
    public static final String ALERT_AUDIO_DURATION = "com.skyfall.panik.ALERT_AUDIO_DURATION";

    /** Extra for alert subscription index */
    public static final String ALERT_AUDIO_SUB_INDEX = "com.skyfall.panik.ALERT_AUDIO_SUB_INDEX";
