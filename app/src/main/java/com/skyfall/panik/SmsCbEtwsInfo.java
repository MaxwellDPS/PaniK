...
public final class SmsCbEtwsInfo implements Parcelable {
    ...
    public long getPrimaryNotificationTimestamp() {
        ...
        int year = gsmBcdByteToInt(mWarningSecurityInformation[0]);
        int month = gsmBcdByteToInt(mWarningSecurityInformation[1]);
        int day = gsmBcdByteToInt(mWarningSecurityInformation[2]);
        int hour = gsmBcdByteToInt(mWarningSecurityInformation[3]);
        int minute = gsmBcdByteToInt(mWarningSecurityInformation[4]);
        int second = gsmBcdByteToInt(mWarningSecurityInformation[5]);
